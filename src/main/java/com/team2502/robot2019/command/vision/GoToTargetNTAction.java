...
public class GoToTargetNTAction extends PeriodicAction
{
    ...
    {
        double tvecs1 = 1; //Robot.tvecs1Entry.getDouble(-9001) - Constants.Autonomous.visionOffset;
    ...
    {
        return Math.abs(visionInfo.getPos().get(1)) <= 0.8 || visionInfo.getPos().get(0) == -9001;
    }
